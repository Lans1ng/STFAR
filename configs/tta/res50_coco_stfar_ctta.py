...
model = dict(
    backbone=dict(
        norm_cfg=dict(requires_grad=False),#False
        norm_eval=True,
        style="caffe",
        init_cfg=dict(
...
data_root = '/root/autodl-fs/_DATASETS/COCO_C_5/'
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
        ...
        img_prefix= data_root + 'images/${corrupt}',
...
semi_wrapper = dict(
    ...
    train_cfg=dict(
        ...
        image_feature_path='./feat_statistics/coco_image_feature.pkl',
        instance_feature_path = './feat_statistics/coco_instance_feature.pkl',
    ),
...
load_from = 'pretrain/res50_coco.pth'
