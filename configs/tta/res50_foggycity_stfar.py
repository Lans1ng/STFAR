...
_base_ = [
    ...
    f"{mmdet_base}/datasets/cityscapes_detection.py",
...
data_root = '/root/autodl-tmp/foggycityscapes/'
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
        ...
        ann_file=data_root +
        'gtFine/instancesonly_filtered_gtFine_val_foggy.json',
    ...
    test=dict(
        ...
        'gtFine/instancesonly_filtered_gtFine_val_foggy.json',
        img_prefix=data_root + 'leftImg8bit/val/',
        # 'gtFine/instancesonly_filtered_gtFine_test.json',
        # img_prefix=data_root + 'leftImg8bit_images/',
        # 'gtFine/instancesonly_filtered_gtFine_val.json',
        # img_prefix=data_root + 'leftImg8bit_images/',
        pipeline=test_pipeline))
...
semi_wrapper = dict(
    ...
    train_cfg=dict(
        ...
        image_feature_path='./feat_statistics/foggycity_image_feature.pkl',
        instance_feature_path = './feat_statistics/foggycity_instance_feature.pkl',
    ),
...
evaluation = dict(type="TTAEvalHook", interval=1, classwise=True, cityscape=True)
...
load_from = 'pretrain/res50_city.pth'
