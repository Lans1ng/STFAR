...
for corrupt in "${corruption_names[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=0 python tools/train.py --config ./configs/tta/res50_voc_selftrain.py --work-dir work_dirs/voc/selftrain/${counter}_${corrupt} --cfg-options corrupt=${corrupt}
